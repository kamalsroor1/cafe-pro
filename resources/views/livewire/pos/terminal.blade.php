    ...
    <div class="flex-1 flex flex-col h-full w-full">
        <header class="h-16 lg:h-20 bg-surface/50 backdrop-blur-xl border-b border-[#2A2A2A] flex items-center justify-between px-4 lg:px-8 shrink-0">
            <div class="flex items-center gap-3 md:gap-6">
                <!-- Back to dashboard -->
                <a href="{{ route('dashboard') }}" class="p-2 min-h-[48px] min-w-[48px] flex items-center justify-center rounded-xl bg-base border border-[#2A2A2A] text-gray-400 hover:text-amber-500 hover:border-amber-500/50 transition-all" title="العودة للموقع">
