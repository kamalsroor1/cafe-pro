<div>
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
        <div class="bg-surface border border-[#2A2A2A] rounded-2xl w-full max-w-lg p-6 shadow-2xl">
            <h3 class="text-xl font-bold text-gray-100 mb-6">{{ $ingredient_id ? 'Edit Ingredient' : 'New Ingredient' }}</h3>
            ...
            <form wire:submit.prevent="save" class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-300">Cost per Unit</label>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-300">Current Stock</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-300">Min Alert Qty</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-300">Supplier (Optional)</label>
